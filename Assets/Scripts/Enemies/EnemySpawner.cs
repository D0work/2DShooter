...
public class EnemySpawner : MonoBehaviour
{
    ...
    private void SpawnEnemy(Vector3 spawnLocation)
    {
        ...
        if (enemyPrefab != null)
        {
            ...
            if (enemyGameObject.GetComponent<SpriteRenderer>()) enemyGameObject.GetComponent<SpriteRenderer>().sprite = enemyPrefab.GetComponent<SpriteRenderer>().sprite;
            if (enemyGameObject.GetComponent<Animator>()) enemyGameObject.GetComponent<Animator>().runtimeAnimatorController = enemyPrefab.GetComponent<Animator>().runtimeAnimatorController;
